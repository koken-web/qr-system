  ...
  return (
    <div className="management-entry-page">
      ...
      <header className="management-entry-header">
        <button
          type="button"
          className="management-entry-back"
          onClick={onBack}
        >
          ← ホームへ戻る
        </button>

        <span className="management-entry-header-label">
          MANAGEMENT
        </span>
      </header>
      ...
      <main className="management-entry-main">
        <section className="management-entry-hero">
          <div className="management-entry-icon">
            <ShieldIcon />
          </div>

          <div>
            <p className="management-entry-kicker">
              管理モード
            </p>
            <h1>管理画面への入口</h1>
            <p className="management-entry-description">
              管理機能を必要になったときだけ読み込みます。
              この画面ではカメラや管理機能を起動しません。
            </p>
          </div>
        </section>
        ...
        <section className="management-entry-status">
          ...
          <div>
            <span className="management-entry-status-label">
              {eventActive ? "イベント開催中" : "イベント待機中"}
            </span>
            <strong>
              {eventConfigured ? eventName : "イベント未設定"}
            </strong>
          </div>
        </section>
        ...
        <section className="management-entry-action-card">
          {eventActive ? (
            <>
              <div className="management-entry-action-icon">
                <QrIcon />
              </div>
              ...
              <button
                type="button"
                className="management-entry-primary-button"
